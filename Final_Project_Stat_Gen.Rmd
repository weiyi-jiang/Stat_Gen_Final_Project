...
Case_Meth_Data$Paired = Case$Paired

Control_Meth_Data$Paired = Control$Paired
...
for (j in seq(1,ncol(Case_Paired_Meth_Data)-2)){
...
for (j in seq(1,ncol(Case_Idep_Meth_Data)-2)){
...
## Manhattan Plot of FDR Corrected P-Values from T Test:
...
axisdf$chrom = c(seq(1,22),"X","Y","NA")

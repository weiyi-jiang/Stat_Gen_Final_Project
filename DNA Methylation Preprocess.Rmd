...
par(mfrow=c(1,2))
densityPlot(RGSets, sampGroups = results$sample_type, main="Raw")
densityPlot(getBeta(GRSets_norm), sampGroups = results$sample_type, main="Normalized")
...
par(mfrow=c(1,2))
densityPlot(mVals, sampGroups=results$sample_type, main="M values", xlab="Beta values")
densityPlot(bVals, sampGroups=results$sample_type, main="Beta values", xlab="Beta values")
